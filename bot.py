...
MONITORED_COINS = [
    ...
    "avalanche-2", "chainlink", "shiba-inu", "polkadot",
    "bitcoin-cash", "uniswap", "litecoin", "near", "aptos",
    "internet-computer", "cosmos", "arbitrum", "optimism",
    "filecoin", "vechain", "the-graph", "aave", "maker",
    "sui", "pepe", "render-token", "injective-protocol",
    "jupiter-exchange-solana", "celestia", "mantle",
]
